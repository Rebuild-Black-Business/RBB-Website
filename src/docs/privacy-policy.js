...
function Privacy() {
  return (
    <p>
      ...
      Privacy applies to rebuildblackbusiness.com and Rebuild Black Business and
      governs data collection and usage. For the purposes of this Privacy
      Policy, unless otherwise noted, all references to Rebuild Black Business
      include rebuildblackbusiness.com and RBB. The RBB website is a Non-Profit
      site. By using the RBB website, you consent to the data practices
      described in this statement.
      <br />
      <br />
      <strong>Collection of your Personal Information</strong>
      <br />
      <br /> In order to better provide you with products and services offered
      on our Site, RBB may collect personally identifiable information, such as
      your:
      <br />
      <br />
      - First and Last Name
      ...
      information or personally sensitive data through RBB's public message
      ...
      <br />
      <br />
      RBB collects and uses your personal information to operate its website(s)
      and deliver the services you have requested.
      <br />
      <br />
      RBB may also use your personally identifiable information to inform you of
      other products or services available from RBB and its affiliates.
      <br />
      <br />
      <strong>Sharing Information with Third Parties</strong>
      <br />
      <br />
      RBB does not sell, rent or lease its customer lists to third parties.
      <br />
      <br />
      RBB may, from time to time, contact you on behalf of external business
      ...
      RBB may share data with trusted partners to help perform statistical
      ...
      your personal information except to provide these services to RBB, and
      they are required to maintain the confidentiality of your information.
      <br />
      <br />
      RBB may disclose your personal information, without notice, if required to
      do so by law or in the good faith belief that such action is necessary to:
      (a) conform to the edicts of the law or comply with legal process served
      on RBB or the site; (b) protect and defend the rights or property of RBB;
      and/or (c) act under exigent circumstances to protect the personal safety
      of users of RBB, or the public.
      <br />
      <br />
      <strong>Tracking User Behavior</strong>
      <br />
      <br />
      RBB may keep track of the websites and pages our users visit within RBB,
      in order to determine what RBB services are the most popular. This data is
      used to deliver customized content and advertising within RBB to customers
      ...
      of the service, and to provide general statistics regarding use of the RBB
      website.
      <br />
      <br />
      <strong>Links</strong>
      ...
      his or her right of free speech, or exercise another right provided for by
      law;
      <br />
      ...
      ethics and privacy laws, when our deletion of the information is likely to
      render impossible or seriously impair the achievement of such research,
      ...
      ABOUT YOU TO OTHERS (IN ACCORDANCE WITH YOUR PRIVACY SETTINGS ON THOSE
      THIRD PARTY SITES). IF YOU DO NOT WANT INFORMATION ABOUT YOU, INCLUDING
      PERSONALLY IDENTIFYING INFORMATION, TO BE SHARED IN THIS MANNER, DO NOT
      USE THIS FEATURE. You may disconnect your account from a third party
      account at any time. Users can discponnecy access to their accounts on
      third-party sites by submitting request for this information to be removed
      from the rebuildblackbusiness.com site.
      <br />
      <br />
      <strong>E-mail Communications</strong>
      <br />
      From time to time, RBB may contact you via email for the purpose of
      ...
      Services, we may receive a notification when you open an email from RBB or
      click on a link therein.
      <br />
      <br />
      If you would like to stop receiving marketing or promotional
      communications via email from RBB, you may opt out of such communications
      by clicking the unsubscribe link within the email..
      <br />
      <br />
